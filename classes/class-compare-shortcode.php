...
class compare_shortcode
{
    ...
    public function cap_shortcode_reviews( $products )
    {
		...
		<div class="cap_amz_review">
			<iframe class="cap-amz-review" src="<?php 
        echo  $products['amz']['reviews'] ;
        ?>" width="100%"
			        height="auto"></iframe>
		</div>
		<?php 
    ...
    public function cap_shortcode_basic( $products )
    {
		...
		<div class="compare_basic_amz">
			<h3><?php 
        echo  esc_attr( $products['amz']['title'] ) ;
        ?></h3>
			<div class="main-row">
				<div class="compare_basic_sc_left">
					<img src="<?php 
        echo  esc_url( $products['amz']['img'] ) ;
        ?>"/>
				</div>
        ...
        if ( !empty($products['amz']['reviews']) ) {
            ...
            echo  $color ;
            ?>; "><?php 
            _e( 'Read the reviews', 'compare-affiliated-products' );
            ?></button>
						<div id="popup">
							<div id="popup-bg"></div>
							<div id="popup-fg">
            ...
            echo  $color ;
            ?>; "><?php 
            _e( 'Close', 'compare-affiliated-products' );
            ?></button>
								</div>
							</div>
						</div>
    ...
    public function cap_template_price(
        $p,
        $text,
        $color,
        $bg,
